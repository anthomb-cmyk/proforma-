...
function buildTranslatorSystemPrompt({ threadState, listing, currentMessage = "" }) {
  ...
  return [
    ...
    "- Un message peut contenir À LA FOIS une question logement ET des informations de qualification — extraire les deux",
    "- \"je suis cuisinier je peut visiter quand\" → employment_status: \"cuisinier\", listing_question: \"visit\"",
    "- \"on va etre 3 personnes est ce quil a du parking\" → occupants_total: 3, listing_question: \"parking\"",
    "- \"je travaille au tim jai un chien\" → employer: \"Tim Hortons\", has_animals: true, animal_type: \"chien\"",
